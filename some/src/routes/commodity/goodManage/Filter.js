  ...
  return (
    <Row gutter={24}>
      ...
      <Col {...ColProps} xl={{ span: 4 }} md={{ span: 6 }}>
         商品标题&emsp;
        {getFieldDecorator('name', { initialValue: name })(<input placeholder="请输入商家名称"  />)}
      </Col>
      <Col {...ColProps} xl={{ span: 3 }} md={{ span: 6 }} id="addressCascader">
      ...
      <Col {...ColProps} xl={{ span: 3 }} md={{ span: 6 }}>
        {getFieldDecorator('name', { initialValue: name })(<Search placeholder="请输入商家编号"  />)}
      </Col>
      <Col {...ColProps} xl={{ span: 3 }} md={{ span: 6 }} id="addressCascader">
        {getFieldDecorator('address', { initialValue: address })(<Cascader
          style={{ width: '100%' }}
      ...
      <Col {...TwoColProps} xl={{ span: 10 }} md={{ span: 24 }} sm={{ span: 24 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap' }}>
          ...
          <div className="flex-vertical-center">
            ...
            <Button type="ghost" onClick={onAdd}>添加分类</Button>
          </div>
        </div>
      </Col>
    </Row>
