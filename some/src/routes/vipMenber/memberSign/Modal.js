    ...
    <Modal {...modalOpts} >
      <div>
          ...
          <h3>账户信息</h3>
            <div>
              <span>姓名:</span>
              <span style={{margin:'10px 0',}}>{modalOpts.currentItem[0].authentication_info.authentication_real_name}</span>
            </div>
            <div>
              <span>身份证号码:</span>
              <span style={{margin:'10px 0',}}>{modalOpts.currentItem[0].authentication_info.authentication_idcard_num}</span>
            </div>
            <div style={{background:'url('+imgSrc+modalOpts.currentItem[0].authentication_info.authentication_idcard_facade_url+') no-repeat',backgroundSize:'cover',width:'90%',height:'100px'}}></div>
            <div style={{background:'url('+imgSrc+modalOpts.currentItem[0].authentication_info.authentication_idcard_back_url+') no-repeat',backgroundSize:'cover',width:'90%',height:'100px'}}></div>
