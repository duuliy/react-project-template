...
import { create, remove, update,query,getRefund } from 'services/order/salesReturnList'
...
export default modelExtend(pageModel, {
  ...
  subscriptions: {
    setup ({ dispatch, history }) {
      history.listen((location) => {
        if (location.pathname === '/salesReturnList') {
  ...
  effects: {
    ...
    *getRefundOrder({payload},{call,put}){
        const getRefundOrder = yield call(getRefund, payload)
