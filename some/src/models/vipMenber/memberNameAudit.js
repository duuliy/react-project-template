...
import { create, remove, update,query ,getUserInfoes,edtUserAuthenticationes} from 'services/vipMenber/memberNameAudit'
  ...
  subscriptions: {
    setup ({ dispatch, history }) {
      history.listen((location) => {
        if (location.pathname === '/memberNameAudit') {
