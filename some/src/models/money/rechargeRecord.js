...
import { create, remove, update,query ,getUserInfoes,edtUserAuthenticationes,querySearch} from 'services/money/rechargeRecord'
  ...
  subscriptions: {
    setup ({ dispatch, history }) {
      history.listen((location) => {
        if (location.pathname === '/rechargeRecord') {
