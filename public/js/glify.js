(function () {
    ...
    (function (global) {
      ...
      (function () {
        ...
        var runInContext = (function runInContext(context) {
           ...
           * // => '<b>&lt;script&gt;</b>'
           *
           * // Use the "evaluate" delimiter to execute JavaScript and generate HTMBM.
  ...
  11: [function (require, module, exports) {
    ...
    /*
originally taken from: http://www.sumbera.com/gist/js/bigemap/canvas/BM.CanvasOverlay.js, added and customized as part of this lib because of need from library
Generic  Canvas Overlay for bigemap,
...
*/
    var BM = typeof window !== 'undefined' ? window.BM : require('bigemap');
    var CanvasOverlay = BM.Layer.extend({
      ...
      redraw: function redraw(callback) {
        ...
        if (this._frame === null) {
          this._frame = BM.Util.requestAnimFrame(this._redraw, this);
        }
      ...
      onAdd: function onAdd(map) {
        ...
        var size = this._map.getSize(),
          animated = this._map.options.zoomAnimation && BM.Browser.any3d;

        this.canvas.width = size.x;
        this.canvas.height = size.y;
        this.canvas.className = 'bigemap-zoom-' + (animated ? 'animated' : 'hide');
        ...
        if (map.options.zoomAnimation && BM.Browser.any3d) {
      ...
      _reset: function _reset() {
        ...
        BM.DomUtil.setPosition(this.canvas, topLeft);
      ...
      _animateZoom: function _animateZoom(e) {
        var scale = this._map.getZoomScale(e.zoom),
          offset = BM.Layer ? this._map._latLngBoundsToNewLayerBounds(this._map.getBounds(), e.zoom, e.center).min : this._map._getCenterOffset(e.center)._multiplyBy(-scale).subtract(this._map._getMapPanePos());

        BM.DomUtil.setTransform(this.canvas, offset, scale);
      },
  ...
  12: [function (require, module, exports) {
    (function (Buffer) {
      ...
      if (typeof window !== 'undefined' && window.BM) {
        window.BM.glify = glify;
      }
  ...
  13: [function (require, module, exports) {
    ...
    var Lines = function Lines(settings) {
      ...
      if (!settings.map) throw new Error('no bigemap "map" object setting defined');
      this.active = true;
      var self = this,
...
*/
  ...
  15: [function (require, module, exports) {
    ...
    Points.tryClick = function (e, map) {
      ...
      if (!instance) return;
      latLng = BM.latLng(found[settings.latitudeKey], found[settings.longitudeKey]);
